...
class Registration_course_model extends CI_Model
{
	private $_tkt_table_name = 'registration_course';
	private $_tkt_fields;
	...
	*/
	public function tkt_get_list($limit=0,$offset=0,$order='ASC',$field='')
	{
		...
		$this->db->join('khoahoc','khoahoc.kh_id=registration_course.rc_course_id');
